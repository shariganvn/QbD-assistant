...
This project is indexed by GitNexus as **QbD-assistant** (1019 symbols, 1133 relationships, 5 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
