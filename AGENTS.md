...
This project is indexed by GitNexus as **QbD-assistant** (3726 symbols, 5379 relationships, 121 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
